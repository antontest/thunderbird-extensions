	...
	function processNewItem(item) {
		try {
			...
			if (growlgntp.isRss(msg.messageId)) {
				...
				growlgntp.rssqueue.push({ type: "newrss", title: author, message: msg.mime2DecodedSubject, callbackContext: uri, callbackType: "rss" });
				...
				growlgntp.mailqueue.push({ type: "newmail", title: author, message: msg.mime2DecodedSubject, priority: priority, callbackContext: uri, callbackType: "mail" });
